...
$user_id=$_SESSION['uid'];
    ...
    while($row=mysql_fetch_array($result)){
      ...
      $name= strtoupper($name);
		...
		$query="SELECT * FROM mycrafts WHERE uniqueid='$user_id'
    ORDER by time DESC";
...
<script type="text/javascript"> 
function loopbox(craftid,userid)
{
  ...
  $.ajax({
        type: "POST",
        url: "loopin.php",
        data: { craftid:craftid , userid:userid },
        dataType: "text",
        cache: false, 
...
<div class="wholeheading">  
  ...
  <div class="popnumber"><span class="popnumber1"><?php echo $view_count;?></span></div>
  ...
  <div class="stampscollection">
   ...
   <div class="circlestamp">
   <div class="tooltip" title="add to LoopBox" onclick="loopbox('<?php echo $craft_id ; ?>','<?php echo $craft_userid ; ?>')"><div class="exp" ></div></div>
...
?>
            ...
            <div>       
   <a id="back" href="mycrafts.php?page=<?php echo $page-8; ?>"><input type="submit" value="Back" style='margin-left:25PX; margin-top:30px;font-family: "Monda","myfont"; color:#cc4d4d;
font-size:20px;'/></a>
  <a id="next" href="mycrafts.php?page=<?php echo $page+8; ?>"><input type="submit" value="Next" style='margin-left:740PX; margin-bottom:70px; margin-top:70px;font-family: "Monda","myfont"; color:#cc4d4d;
font-size:20px;' /></a>
</div>
...
<div class="boxcontent">
    ...
    <form method="post" action="mycrafts.php" enctype='multipart/form-data'>
     <div class="boxborder">
