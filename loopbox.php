<?php 
  ...
  session_start();
	 ...
	 if($db)
   {
		$query="SELECT * FROM loopboxgate ORDER by total DESC";
...
<script type="text/javascript">
function stamp(type,craftid,userid)
{
  $.ajax({
        type: "POST",
        url: "loopboxrate.php",
        data: { craftid:craftid , userid:userid , type:type },
        dataType: "text",
        cache: false, 
...
<?php
      ...
      $user_id=$row['uniqueid'];*/
            ...
            $query="SELECT * FROM mycrafts WHERE uniqueid='$user_id' AND craftname='$craft_id' ";
...
<div class="wholeheading">  
  ...
  <div class="stampscollection">
   ...
   <div class="tooltip" title="gold stamp" onclick="stamp('1','<?php echo $craft_id ; ?>','<?php echo $user_id ; ?>')"><div class="gold"></div></div>
   
   <span class="stampnumber" id="gold" style="text-align:center;"><?php echo $stampG; ?></span></div>
   <div class="circlestamp">
   <div class="tooltip" title="silver stamp" onclick="stamp('2','<?php echo $craft_id ; ?>','<?php echo $user_id ; ?>')"><div class="silver"></div></div>
   <span class="stampnumber" id="silver"><?php echo $stampS; ?></span></div>
   <div class="circlestamp">
   <div class="tooltip" title="bronze stamp" onclick="stamp('3','<?php echo $craft_id ; ?>','<?php echo $user_id ; ?>')"><div class="bronze"></div></div>
   <span class="stampnumber" id="bronze"><?php echo $stampB; ?></span>
   </div>
   <!--<div class="circlestamp">
 ...
 <div class="userdetailscaption">
   ...
   <a href="" style="text-decoration:underline; color:#FFF;"><?php echo $name;?></a></p>
   <p style="margin-top:-14px;margin-left:4px; color:#FFF;text-decoration:underline;"> <?php echo $genre; ?> </p></div><!--username2 div-->
...
<div class="boxcontent">
    ...
    <form method="post" action="loopbox.php" enctype='multipart/form-data'>
     <div class="boxborder">
